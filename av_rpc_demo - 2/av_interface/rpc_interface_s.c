...
extern const RPC_DISPATCH_TABLE AVInterface_v1_0_DispatchTable;
...
static const RPC_DISPATCH_FUNCTION AVInterface_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE AVInterface_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)AVInterface_table
    };
