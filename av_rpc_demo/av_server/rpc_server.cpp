...
RPC_STATUS CALLBACK RPCServer::SecurityCallback(RPC_IF_HANDLE /*hInterface*/, void* /*pBindingHandle*/)
{
	return RPC_S_OK; // Always allow anyone.
}

void* __RPC_USER RPCServer::midl_user_allocate(size_t size)
{
	return malloc(size);
}

void __RPC_USER RPCServer::midl_user_free(void* p)
{
	free(p);
}
